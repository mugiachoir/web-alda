    ...
    <div class="row">
        <div class="col-8">
            ...
            <form action="/komik/update/<?= $komik['id']; ?>" method="post" enctype="multipart/form-data">
                ...
                <input type="hidden" name="fileLama" value="<?= $komik['sampul']; ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input  <?= ($validation->hasError('sampul')) ? "is-invalid" : ""; ?>" id="sampul" name="sampul" onchange="preview()" value="<?= (old('penerbit')) ? old('sampul') : $komik['sampul']; ?>">
                            <div class="invalid-feedback">
