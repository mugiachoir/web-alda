        ...
        <div class="col-8">
            ...
            <form action="/komik/save" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <img src="/img/kuro.jpg" class="img-thumbnail img-preview">
                    </div>
                    <div class="col-sm-8">
                        <div class="custom-file">
                            <input type="file" class="custom-file-input  <?= ($validation->hasError('sampul')) ? "is-invalid" : ""; ?>" id="sampul" name="sampul" onchange="preview()">
                            <div class="invalid-feedback">
