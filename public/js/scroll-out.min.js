var ScrollOut = function () {
    ...
    return function (L) {
        ...
        function n() {
            ...
            H || !A && !c || (l = C, z.push(l), F(), H = function () {
        ...
        function C() {
            ...
            for (var e = y.length - 1; - 1 < e; e--) {
                ...
                t._changed && (t._changed = !1, f(n, t)), t._visibleChanged && (h(n, {
                    scroll: r ? "in" : "out"
                }), o(n, t, x), (r ? c : l)(n, t, x)), r && L.once && y.splice(e, 1)
            }
        }
        ...
        return window.addEventListener("resize", a), W.addEventListener("scroll", a), {
            index: t,
            update: n,
            teardown: function () {
                u(), window.removeEventListener("resize", a), W.removeEventListener("scroll", a)
            }
        }
    }
}();